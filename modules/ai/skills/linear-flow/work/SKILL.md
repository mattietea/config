...
2. **Claim.** `linear issue start <id>` — assigns, branches, and moves to In Progress. Then `linear issue update <id> --cycle active` — starting a ticket puts it in the current cycle.
